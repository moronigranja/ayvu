...
/**
 * Host-side [OperationRunner]: records the spec (the id IS the cancel address
 * the UI depends on), runs the body on [scope], and captures body failures the
 * way the real runner posts a terminal notification instead of throwing into
 * the caller.
 */
