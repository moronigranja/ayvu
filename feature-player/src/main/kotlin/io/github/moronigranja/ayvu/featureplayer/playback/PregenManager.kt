...
class PregenManager
    ...
    constructor(
        ...
        // Lazy: the Hilt-provided Configuration.Provider (AyvuApp) reads
        ...
        fun pregenerate(
            ...
            val withBudget =
                budgetMinutes?.let { minutes ->
                    Data
                        .Builder()
                        .putAll(input)
                        .putLong(PregenWorker.KEY_BUDGET_MINUTES, minutes)
                        .build()
                } ?: input
         ...
         * it deterministically at startup (AyvuApp.onCreate). A fresh
