...
data class OpenTarget(
    ...
    companion object {
        const val EXTRA_BOOK_ID = "io.github.moronigranja.ayvu.open.bookId"
        const val EXTRA_CHAPTER = "io.github.moronigranja.ayvu.open.chapter"
        const val EXTRA_PASSAGE = "io.github.moronigranja.ayvu.open.passage"
