...
class ActivitySecondsDaoTest {
    ...
    @Test
    fun `migration to v3 keeps v1 data and the stats table works`() = runTest {
    ...
    @Test
    fun `accumulate adds seconds on conflict instead of replacing`() = runTest {
    ...
    @Test
    fun `a day needs a full combined minute to be active`() = runTest {
    ...
    @Test
    fun `RoomLibraryStore delete drops the book's activity rows only`() = runTest {
