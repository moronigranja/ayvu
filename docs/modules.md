...
feature-settings/ LIVE — V1: settings screen (root + Speech subscreen — pane pattern shared with the OCR-languages picker, #156/#168), packs download UI (engine-agnostic, descriptor-derived — K2 #156), voice picker + favorites, threshold, OCR langs, theme; AndroidHttpTransport; Offline-audio section (per-book usage + delete, #44); "Backup & restore" SAF export/import (E1, #111); About group (version via the AppInfo seam, GPL-3.0 source link, NOTICE link, on-device privacy line — release 0.1.1)
